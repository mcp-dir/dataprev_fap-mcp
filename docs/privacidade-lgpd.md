...
Dataprev: Fator Acidentário de Prevenção (FAP) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [dataprev_fap@mcp.ai](mailto:dataprev_fap@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
